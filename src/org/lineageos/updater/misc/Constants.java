...
public final class Constants {
    ...
    public static final String PROP_BUILD_VERSION = "ro.voltage.version";
    public static final String PROP_DEVICE = "ro.build.product";
    public static final String PROP_NEXT_DEVICE = "ro.updater.next_device";
    public static final String PROP_RELEASE_TYPE = "ro.voltage.buildtype";
    public static final String PROP_UPDATER_ALLOW_DOWNGRADING = "voltage.updater.allow_downgrading";
    public static final String PROP_UPDATER_URI = "voltage.updater.uri";
